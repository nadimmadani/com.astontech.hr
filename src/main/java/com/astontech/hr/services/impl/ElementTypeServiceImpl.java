...
public class ElementTypeServiceImpl implements ElementTypeService{
    ...
    @Override
    public ElementType findByElementTypeName(String elementType) {
        return elementTypeRepository.findByElementTypeName(elementType);
    }

    @Override
    public ElementType findByElementTypeNameIgnoreCase(String elementType) {
        return elementTypeRepository.findByElementTypeNameIgnoreCase(elementType);
    }
}
